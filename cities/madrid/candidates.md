# Madrid — crosswalk candidates

Generated 2026-09-15 · ckan · `https://datos.madrid.es`

**This is not a crosswalk.** A grade is a human judgment (comparability spec v0.1), so this is the worksheet a local analyst grades. Nothing here may be charted until someone does.

- catalog: **672** datasets (0 publish field names — matching is weaker without them)
- indicators probed: **80** (city-scoped, usable UN coverage)
- with at least one candidate above this catalog's cutoff: **16**

> ⚠ **No sourced population denominator for this city.** Rate-based indicators (most SDG health and safety measures are per 100,000) cannot be completed until one is recorded in `cities/registry.json` with its source.

| z | Sim | UN indicator | Candidate dataset | Grade (fill in) |
|---|---|---|---|---|
...
| 5.8 | 0.61 | Change in permanent water area of lakes and rivers | [Calidad del vertido de las aguas residuale](https://datos.madrid.es/dataset/300146-0-depuradoras-vertido) | |
| 5.8 | 0.56 | Level of achievement regarding legal frameworks that | [La violencia sexual en la ciudad de Madrid](https://datos.madrid.es/dataset/8562-0-la-violencia-sexual-en-la-ciudad-de-madrid) | |
| 5.7 | 0.61 | Seasonal water area of lakes and rivers | [Calidad del vertido de las aguas residuale](https://datos.madrid.es/dataset/300146-0-depuradoras-vertido) | |
| 5.7 | 0.58 | Minimum reservoir water area | [Volumen del agua regenerada](https://datos.madrid.es/dataset/300149-0-agua-regenerada) | |
| 5.7 | 0.61 | Permanent water area of lakes and rivers | [Calidad del vertido de las aguas residuale](https://datos.madrid.es/dataset/300146-0-depuradoras-vertido) | |
